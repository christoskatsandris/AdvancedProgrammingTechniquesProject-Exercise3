...
public class MessageController {
	...
	@RequestMapping(value = "/message", produces = { "application/json;charset=utf-8" }, consumes = { "text/plain" }, method = RequestMethod.POST)
	public ResponseEntity<Message> postMessage(@ApiParam(value = "The text to be posted", required = true) @RequestBody String text) {
